    ...
    public class UtilsiOS
    {
        ...
        public static string GetDeviceName()
        {
            ...
            switch (deviceName)
            {
                ...
                case "iPad2,4": return "iPad 2 WiFi Rev";
                case "iPad2,5": return "iPad mini WiFi";
                case "iPad2,6":
                case "iPad2,7": return "iPad mini";
                case "iPad3,1": return "iPad 3 WiFi";
                case "iPad3,2": return "iPad 3 WiFi LTE";
                case "iPad3,3": return "iPad 3 WiFi LTE AT&T";
                case "iPad3,4": return "iPad 4 WiFi";
                case "iPad3,5":
                case "iPad3,6": return "iPad 4";
                case "iPad4,1": return "iPad Air WiFi";
                case "iPad4,2": return "iPad Air WiFi LTE";
                case "iPad4,3": return "iPad Air Rev";
                case "iPad4,4": return "iPad mini 2 WiFi";
                case "iPad4,5": return "iPad mini 2 WiFi LTE";
                case "iPad4,6": return "iPad mini 2 Rev";
                case "iPad4,7": return "iPad mini 3 WiFi";
                case "iPad4,8":
                case "iPad4,9": return "iPad mini 3";
                case "iPad5,1": return "iPad mini 4 WiFi";
                case "iPad5,2": return "iPad mini 4 WiFi LTE";
                case "iPad5,3": return "iPad Air 2 WiFi";
                case "iPad5,4": return "iPad Air 2 WiFi LTE";
                case "iPad6,3": return "iPad Pro 9.7 WiFi";
                case "iPad6,4": return "iPad Pro 9.7 WiFi LTE";
                case "iPad6,7": return "iPad Pro 12.9 WiFi";
                case "iPad6,8": return "iPad Pro 12.9 WiFi LTE";
                case "iPad6,11": return "iPad 5 9.7 WiFi";
                case "iPad6,12": return "iPad 5 9.7 WiFi LTE";
                case "iPad7,1": return "iPad Pro 2nd Gen WiFi";
                case "iPad7,2": return "iPad Pro 2nd Gen WiFi LTE";
                case "iPad7,3":
                case "iPad7,4": return "iPad Pro 10.5";
                case "iPad7,5": return "iPad 6th Gen WiFi";
                case "iPad7,6": return "iPad 6th Gen WiFi LTE";
                case "iPad8,1": return "iPad Pro 11 3rd Gen WiFi";
                case "iPad8,2": return "iPad Pro 11 3rd Gen 1TB WiFi";
                case "iPad8,3": return "iPad Pro 11 3rd Gen WiFi LTE";
                case "iPad8,4": return "iPad Pro 11 3rd Gen 1TB WiFi LTE";
                case "iPad8,5": return "iPad Pro 12.9 3rd Gen WiFi";
