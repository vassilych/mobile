    ...
    public class SfWidget : DroidVariable
    {
                                               ...
                                               int width, int height)
        {
            switch (widgetType)
            {
                ...
                case "SfColumnGraph":
                    return new SfWidget(SfWidget.SyncFusionType.COLUMN_GRAPH, widgetName, initArg, MainActivity.TheView);
            ...
            else if (m_chart != null)
            {
                ...
                else if (SfType == SyncFusionType.SPLINE_GRAPH)
                {
                    ...
                    if (!string.IsNullOrEmpty(extra))
                    {
                        ...
                        var color2 = colors.Length > 1 ? UtilsDroid.String2Color(colors[1]) : series.Color;
                        series.DataMarker.MarkerColor = color2;
                        series.DataMarker.MarkerStrokeColor = color2;
                    }
